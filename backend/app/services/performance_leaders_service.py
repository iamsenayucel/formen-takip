...
class PerformanceLeadersService:
    ...
    def _month_leader(self, year: int, month: int) -> dict | None:
    ...
    def leaders(self) -> dict:
        ...
        monthly_leaders_by_month = {m: self._month_leader(year, m) for m in range(1, month + 1)}
        ...
        ytd_filters = Filters(date_from=date(year, 1, 1), date_to=month_end)
